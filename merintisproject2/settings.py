"""
Django settings for merintisproject2 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-&q1ui=6$m1_c$qt@17=b!!7kz0$ba%e2n1ud099-1lrwysu8(l')
...
ROOT_URLCONF = 'merintisproject2.urls'
...
WSGI_APPLICATION = 'merintisproject2.wsgi.application'
